...
@Component({
  ...
  <form [formGroup]="addPartyForm" >
        ...
        <input  type = "text" class ="form-control" id ="newemail" formControlName = "email" placeholder="Email " >
...
<!-- <button (click)="downloadAsPDF()" style="color: green; margin-left:1px; " class="button" > Submit </button> -->
  </div>
...
downloadAsPDF() {
    ...
    const html = htmlToPdfmake(pdfInvoice.innerHTML);
